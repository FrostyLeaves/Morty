...
MStringId MShaderPropertyName::IMGUI_IMAGE_TYPE = MStringId("u_texScreenTexture");
MStringId MShaderPropertyName::IMGUI_IMAGE_ARRAY = MStringId("u_texScreenTexture");
MStringId MShaderPropertyName::IMGUI_IMAGE_INDEX = MStringId("u_texScreenTexture");
