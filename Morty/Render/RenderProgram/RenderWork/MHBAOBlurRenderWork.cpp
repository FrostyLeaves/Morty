...
{
    return {{MHBAORenderWork::HBAOOutput, METextureBarrierStage::EPixelShaderSample}};
}

std::vector<MRenderTaskOutputDesc> MHBAOBlurRenderWorkV::InitOutputDesc()
{
    return {{MHBAOBlurRenderWorkV::BlurOutput, {true, MColor::Black_T, 0}}};
}
...
{
    return {{MHBAOBlurRenderWorkV::BlurOutput, METextureBarrierStage::EPixelShaderSample}};
}

std::vector<MRenderTaskOutputDesc> MHBAOBlurRenderWorkH::InitOutputDesc()
{
    return {{MHBAOBlurRenderWorkH::BlurOutput, {true, MColor::Black_T, 0}}};
}