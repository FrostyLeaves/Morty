...
void MEnvironmentMapRenderWork::InitializeResource()
{
	...
	{
		pDiffuseCubeMapResource->CreateCubeMapRenderTarget(EnvironmentTextureSize, EnvironmentTextureSize, 4, METextureFormat::Float_RGBA16, false);
	...
	{
		pSpecularCubeMapResource->CreateCubeMapRenderTarget(EnvironmentTextureSize, EnvironmentTextureSize, 4, METextureFormat::Float_RGBA16, true);
