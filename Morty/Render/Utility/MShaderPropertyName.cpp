...
MStringId MShaderPropertyName::MATERIAL_TEXTURE_ALBEDO     = MStringId("texAlbedo");
MStringId MShaderPropertyName::MATERIAL_TEXTURE_NORMAL     = MStringId("texNormal");
MStringId MShaderPropertyName::MATERIAL_TEXTURE_METALLIC   = MStringId("texMetallic");
MStringId MShaderPropertyName::MATERIAL_TEXTURE_ROUGHNESS  = MStringId("texRoughness");
MStringId MShaderPropertyName::MATERIAL_TEXTURE_AMBIENTOCC = MStringId("texAO");
MStringId MShaderPropertyName::MATERIAL_TEXTURE_HEIGHT     = MStringId("texHeight");
