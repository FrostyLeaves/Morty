...
class MORTY_API MVulkanShaderCompilerGlslang : public MVulkanShaderCompiler
{
public:
    explicit MVulkanShaderCompilerGlslang(MVulkanDevice* pDevice);

    ~MVulkanShaderCompilerGlslang();
