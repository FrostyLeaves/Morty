...
float3 CalcPointLight(PointLight pointLight, float3 f3CameraDir, float3 f3Normal, float3 f3WorldPixelPoint, float3 f3AmbiColor, float3 f3DiffColor, float3 f3SpecColor)
{
