...
template<> inline MString IniConfig::GetValue<MString>(const char* section, const char* name)
{
...
template<> inline void IniConfig::SetValue<MString>(const char* section, const char* name, const MString& value)
{
...
template<> inline void IniConfig::SetValue<int>(const char* section, const char* name, const int& value)
{
...
template<> inline void IniConfig::SetValue<bool>(const char* section, const char* name, const bool& value)
{
    SetValue<int>(section, name, value ? 1 : 0);
}

template<> inline Vector2i IniConfig::GetValue<Vector2i>(const char* section, const char* name)
{
    auto value = GetValue<MString>(section, name);
...
template<> inline void IniConfig::SetValue<Vector2i>(const char* section, const char* name, const Vector2i& value)
{
