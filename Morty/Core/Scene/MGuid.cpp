...
bool MGuid::operator!=(const MGuid& other) const { return !operator==(other); }

bool MGuid::operator<(const MGuid& other) const
{
    if (data[0] != other.data[0]) return data[0] < other.data[0];
    if (data[1] != other.data[1]) return data[1] < other.data[1];
    if (data[2] != other.data[2]) return data[2] < other.data[2];
    if (data[3] != other.data[3]) return data[3] < other.data[3];
